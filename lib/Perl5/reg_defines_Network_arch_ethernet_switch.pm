...
package reg_defines_Network_arch_ethernet_switch;
...
sub DEVICE_PROJ_DIR ()  { "Network_arch_ethernet_switch"; }
sub DEVICE_PROJ_NAME () { "Ethernet Hub"; }
sub DEVICE_PROJ_DESC () { "Ethernet Hub"; }
